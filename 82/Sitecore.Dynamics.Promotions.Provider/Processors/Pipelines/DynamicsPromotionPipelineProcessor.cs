...
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
namespace Sitecore.Dynamics.Promotions.Provider.Processors.Pipelines
{
    ...
    /// </summary>
    /// <seealso cref="DynamicsPromotionPipelineProcessor" />
    public class DynamicsPromotionPipelineProcessor : PipelineProcessor
    {
        /// <summary>
