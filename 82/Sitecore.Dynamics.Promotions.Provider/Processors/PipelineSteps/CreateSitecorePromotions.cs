...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace Sitecore.Dynamics.Promotions.Provider.Processors.PipelineSteps
{
    using System;
    ...
    using Sitecore.Dynamics.Promotions.Provider.Models;
    using Sitecore.DataExchange.Contexts;
    using Sitecore.DataExchange.Models;
    using Sitecore.Services.Core.Model;
    using Sitecore.DataExchange.Processors.PipelineSteps;
    using Sitecore.Dynamics.Promotions.Provider.PromotionService;

    /// <summary>
    ///     Create Sitecore Promotions class
    /// </summary>
    public class CreateSitecorePromotions : BasePipelineStepProcessor
    {
        ...
        private const string EndPointsPath = "/sitecore/system/Data Exchange/Commerce Tenant/Endpoints/Providers/Dynamics promotions";
        ...
        private const string DynamicsEndPointTemplate = "Dynamics Promotion";
        ...
        private static IEnumerable<DynamicsPromotionLine> GetDynamicsPromotionLines(IEnumerable<string> itemList, DynamicsEndPoint endPoint)
        {
            ...
            var returnList = 
                (from promoLine in GetPromotionServiceClient(endPoint).GetItemDiscounts(GetCallContext(endPoint), Convert.ToInt64(endPoint.ChannelId), endPoint.Currency, list.ToArray())
        ...
        private static IEnumerable<DynamicsPromotion> GetDynamicsPromotions(DynamicsEndPoint endPoint)
        {
            return (from promotion in GetPromotionServiceClient(endPoint).GetAllDiscounts(GetCallContext(endPoint), Convert.ToInt64(endPoint.ChannelId))
                    select new DynamicsPromotion
                    {
                        ...
                        StartDate = MapToSitecoreDate(promotion.parmStartDate),
                        EndDate = MapToSitecoreDate(promotion.parmEndDate),
