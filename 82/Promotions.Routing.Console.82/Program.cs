    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            try
            {
                ...
                if (!pipelineBatchs.Any() || pipelineBatchs.FindAll(x => x.Name.Contains("Dynamics promotions batch")).Count == 0)
                {
                ...
                foreach (var pipelineTask in pipelineBatchs.FindAll(x => x.Name.Contains("Dynamics promotions batch")))
                {
